...
contract DonationPool is Ownable, ReentrancyGuard {
    ...
    function donate(uint256 filmId) external payable nonReentrant {
        ...
        // Pull pattern: Track pending withdrawals to avoid DoS
        ...
        // Direct transfer for protocol addresses (trusted)
        (bool successFund, ) = creatorFund.call{value: fundAmount}("");
        require(successFund, "Fund transfer failed");

        (bool successTreasury, ) = treasury.call{value: platformAmount}("");
