...
contract AssetMarketplace is Ownable, ReentrancyGuard {
    ...
    function purchase(uint256 assetId) external payable nonReentrant {
        ...
        uint256 royalty = (msg.value * asset.royaltyBps) / 10000;
        uint256 creatorAmount = msg.value - fee - royalty;

        (bool cSuccess, ) = asset.creator.call{value: creatorAmount + royalty}("");
