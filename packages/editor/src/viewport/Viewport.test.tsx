...
describe('Viewport', () => {
  ...
  it('renders the gizmo mode buttons', () => {
    render(<Viewport />)
  ...
  it('renders gizmo when object is found', async () => {
    ...
    // Fast-forward for the 50ms timeout in ViewportGizmo
    act(() => {
      vi.advanceTimersByTime(100)
    })

    // Use queryByTestId because findByTestId doesn't play well with fake timers in some Vitest versions
    expect(screen.queryByTestId('transform-controls')).toBeTruthy()
  })
})
