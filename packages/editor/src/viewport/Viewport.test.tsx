...
// Mock ResizeObserver
// @ts-expect-error - ResizeObserver is not defined in the environment
...
describe('Viewport', () => {
  ...
  it('renders the 3D viewport components', () => {
    ...
    // SceneManager is NOT rendered in Viewport.tsx, SceneRenderer is.
    // However, SceneRenderer is a local import and not mocked in this test.
  })

  it('renders the tool buttons in toolbar', () => {
    render(<Viewport />)
