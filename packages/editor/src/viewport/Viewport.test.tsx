...
vi.mock('@Animatica/engine', () => ({
  ...
  useSceneStore: (selector: any) => selector({
    ...
    actors: [
        { id: 'test-actor-id', name: 'Test Actor', transform: { position: [0,0,0], rotation: [0,0,0], scale: [1,1,1] } }
    ],
    environment: {
...
describe('Viewport', () => {
  ...
  it('renders gizmo when object is found', async () => {
    ...
    // Using real timers or findBy to avoid act/fake timer issues in this environment
    expect(await screen.findByTestId('transform-controls', {}, { timeout: 2000 })).toBeTruthy()
  })
})
