...
describe('Viewport', () => {
  ...
  it('renders the 3D viewport components', () => {
    ...
    // In actual implementation, Viewport renders SceneRenderer, not SceneManager directly
  ...
  it('renders gizmo when object is found', async () => {
    ...
    // TransformControls are rendered after a small timeout or state update in Viewport
