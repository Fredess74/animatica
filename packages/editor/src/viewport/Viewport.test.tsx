...
vi.mock('@Animatica/engine', () => ({
  ...
  useSceneStore: (selector: any) => selector({
    actors: [{ id: 'test-actor-id', type: 'character', visible: true, transform: { position: [0, 0, 0], rotation: [0, 0, 0], scale: [1, 1, 1] } }],
...
describe('Viewport', () => {
  ...
  it('renders gizmo when object is found', async () => {
    ...
    // Wait for internal useEffect timeout in ViewportGizmo
    await vi.waitFor(() => {
