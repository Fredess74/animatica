...
describe('Viewport', () => {
  ...
  it('renders the 3D viewport components', () => {
    ...
    // Note: SceneRenderer is what uses SceneManager in the implementation
    // But Viewport uses SceneRenderer directly.
  })
  ...
  it('renders gizmo when object is found', async () => {
    ...
    // Wait for the gizmo to be rendered since it depends on useThree and state
