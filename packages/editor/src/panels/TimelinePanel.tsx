    ...
    <div className="panel timeline-panel">
      ...
      <div className="timeline-transport">
        <div className="timeline-transport__controls">
          <button className="timeline-btn" onClick={handleStop} title={t('timeline.stop')}>
            ⏹
          </button>
          {isPlaying ? (
            <button
      ...
      <div className="timeline-scrubber">
        ...
        />
        <div className="timeline-scrubber__progress" style={{ width: `${progressPercent}%` }} />
      </div>
          ...
          <div className="timeline-track">
            ...
            <div className="timeline-track__lane">
              ...
              <span
                ...
                style={{ left: '0%' }}
                title={t('timeline.seconds', { count: 0 })}
              >
                ◆
              </span>
              <span
                className="timeline-keyframe"
                style={{ left: '50%' }}
                title={t('timeline.seconds', { count: duration / 2 })}
              >
                ◆
              </span>
              <span
                className="timeline-keyframe"
                style={{ left: '100%' }}
                title={t('timeline.seconds', { count: duration })}
              >
                ◆
              </span>
            </div>
