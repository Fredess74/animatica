...
describe('CharacterRenderer', () => {
  ...
  it('renders a group containing primitive rig with correct transform', () => {
    ...
    const rig = children.find(child => child.type === 'primitive')
  ...
  it('renders selection indicator when isSelected is true', () => {
    ...
    const material = React.Children.toArray((selectionIndicator as any).props.children).find((c: any) => c.type === 'meshBasicMaterial') as any
