...
describe('CharacterRenderer', () => {
  ...
  it('renders a group containing primitive with correct transform', () => {
    ...
    // First child should be the primitive (character rig)
  ...
  it('renders selection ring when selected', () => {
    ...
    const ringMesh = children[1] as React.ReactElement<any>
    expect(ringMesh.type).toBe('mesh')

    const ringChildren = React.Children.toArray(ringMesh.props.children) as React.ReactElement[]
