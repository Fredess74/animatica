...
describe('CharacterRenderer', () => {
  ...
  it('renders a group containing rig primitive with correct transform', () => {
    // Call the memoized component's function directly
    // @ts-ignore
    ...
    expect(rigProps.object.type).toBe('Group')
  })
