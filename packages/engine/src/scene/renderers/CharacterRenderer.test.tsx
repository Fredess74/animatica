...
describe('CharacterRenderer', () => {
  ...
  it('renders a group containing the rig with correct transform', () => {
    ...
    expect((rigPrimitive as any).props.object).toBeInstanceOf(THREE.Group)
  })
  ...
  it('renders selection indicator when isSelected is true', () => {
    ...
    // Check for ring geometry mesh
    const selectionMesh = children.find((c: any) => c.type === 'mesh' && React.Children.toArray(c.props.children).some((gc: any) => gc.type === 'ringGeometry'))
