...
export const CharacterRenderer = memo(
  forwardRef<THREE.Group, CharacterRendererProps>(
    ({ actor, isSelected = false, onClick }, ref) => {
      ...
      const groupRef = (ref as React.MutableRefObject<THREE.Group>) || internalGroupRef
      ...
      // If actor is not visible, we still return the group but with visible=false
      // to comply with React's Rules of Hooks (don't return early before hooks)
