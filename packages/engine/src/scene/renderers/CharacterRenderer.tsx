 ...
 */
import { useEffect, useRef, useMemo, useImperativeHandle, forwardRef, memo } from 'react'
...
export const CharacterRenderer = memo(
  forwardRef<THREE.Group, CharacterRendererProps>(({
    ...
    // Expose the group ref to parents
    ...
    // Visibility-based early return must be after all hook calls
    if (!actor.visible) {
      return null
    }
