...
/**
 * Renders a character (humanoid) based on the actor's properties.
 * Handles procedural rig generation, animation state, and facial expressions.
 *
 * @component
 */
export const CharacterRenderer = memo(forwardRef<THREE.Group, CharacterRendererProps>(({
  ...
  // Early return after hooks (Rules of Hooks)
