...
/**
 * Renders a character actor using a procedural rig or GLB model.
 * Handles animations, morph targets, and eye tracking.
 */
export const CharacterRenderer = memo(forwardRef<THREE.Group, CharacterRendererProps>(({
  ...
  // Expose groupRef to the parent through the forwarded ref
