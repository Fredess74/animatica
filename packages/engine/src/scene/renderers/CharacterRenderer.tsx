...
export const CharacterRenderer = memo(
  forwardRef<THREE.Group, CharacterRendererProps>(({ actor, isSelected = false, onClick }, ref) => {
    ...
    // Support for parent ref (OrbitControls, TransformControls, etc)
    ...
    useEffect(() => {
      if (animatorRef.current && typeof actor.animationSpeed === 'number') {
    ...
    useFrame((_state, delta) => {
      // Visibility optimization — skip updates if hidden
