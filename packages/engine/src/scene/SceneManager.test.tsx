...
describe('SceneManager', () => {
  ...
  beforeEach(() => {
    ...
    ;(useActorList as any).mockImplementation(() => defaultState.actors)
    ;(useEnvironment as any).mockImplementation(() => defaultState.environment)
    ;(useTimeline as any).mockImplementation(() => defaultState.timeline)
    ;(useCurrentTime as any).mockImplementation(() => defaultState.playback.currentTime)
  })
