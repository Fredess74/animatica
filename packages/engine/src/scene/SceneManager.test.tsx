...
describe('SceneManager', () => {
  ...
  beforeEach(() => {
    ...
    // Setup default hook mock behavior
    vi.mocked(useEnvironment).mockReturnValue(defaultEnvironment as any)
    vi.mocked(useTimeline).mockReturnValue(defaultTimeline as any)
    vi.mocked(useCurrentTime).mockReturnValue(0)
    vi.mocked(useActorList).mockReturnValue([])
  })

  it('renders primitive actors', () => {
    vi.mocked(useActorList).mockReturnValue([{ id: '1', type: 'primitive' }] as any)
  ...
  it('renders light actors', () => {
    vi.mocked(useActorList).mockReturnValue([{ id: '2', type: 'light' }] as any)
  ...
  it('renders camera actors', () => {
    vi.mocked(useActorList).mockReturnValue([{ id: '3', type: 'camera' }] as any)
  ...
  it('renders character actors', () => {
    vi.mocked(useActorList).mockReturnValue([{ id: '4', type: 'character' }] as any)
  ...
  it('renders speaker actors', () => {
    vi.mocked(useActorList).mockReturnValue([{ id: '5', type: 'speaker' }] as any)
