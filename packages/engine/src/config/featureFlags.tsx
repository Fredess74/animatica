...
export const getFeatureFlags = (
  envMode: string = typeof import.meta !== 'undefined' && import.meta.env ? import.meta.env.MODE : 'production',
  env: Record<string, string | boolean | undefined> = typeof import.meta !== 'undefined' && import.meta.env ? (import.meta.env as unknown as Record<string, string | boolean | undefined>) : {}
): FeatureFlags => {
