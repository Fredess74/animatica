...
export const getFeatureFlags = (
  envMode: string = (import.meta as any).env?.MODE || 'production',
  env: Record<string, string | boolean | undefined> = (import.meta as any).env as unknown as Record<string, string | boolean | undefined> || {}
): FeatureFlags => {
