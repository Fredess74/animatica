 ...
 * Optimized with useShallow to prevent re-renders when only actor properties change but the list remains the same.
 */
 ...
 */
export const useActiveActors = () => useSceneStore(useShallow(getActiveActors));
