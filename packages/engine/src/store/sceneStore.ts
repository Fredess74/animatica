...
import { Actor, Environment, ProjectMeta, ProjectState, Timeline } from '../types'
...
export const getActorById =
  (id: string) =>
  (state: SceneStoreState): Actor | undefined =>
 ...
 */
export const getCurrentTime = (state: SceneStoreState): number => state.playback.currentTime
