 ...
 * Optimized with useShallow to prevent re-renders when actor properties change if only the list is needed.
 */
...
/**
 * Hook to get the playback slice (state and actions).
 */
