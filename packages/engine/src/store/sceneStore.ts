...
/**
 * Alias for useActorList.
 */
export const useActors = useActorList;

/**
 * Hook to access undo/redo history controls.
 */
export const useSceneHistory = () => {
    const temporal = useSceneStore.temporal;
    return temporal ? temporal.getState() : {
        undo: () => {},
        redo: () => {},
        clear: () => {},
        pastStates: [],
