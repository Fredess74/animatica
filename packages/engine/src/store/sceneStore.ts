    ...
    persist(
      ...
      })),
      {
        ...
        onRehydrateStorage: () => (state) => {
          if (state) {
            // Rebuild actorsById lookup on rehydration
            state.actorsById = {};
 ...
 * Optimized with useShallow to prevent re-renders when other parts of the store change.
 */
