...
| @types/react | MIT | @Animatica/web, @Animatica/platform, @Animatica/editor, @Animatica/engine |
| @types/react-dom | MIT | @Animatica/web, @Animatica/platform, @Animatica/editor |
...
| react | MIT | @Animatica/web, @Animatica/platform, @Animatica/editor, @Animatica/engine |
| react-dom | MIT | @Animatica/web, @Animatica/platform, @Animatica/editor, @Animatica/engine |
...
| turbo | MIT | Animatica |
| typescript | Apache-2.0 | Animatica, @Animatica/web, @Animatica/contracts, @Animatica/platform, @Animatica/editor, @Animatica/engine |
| uuid | MIT | @Animatica/engine |
| vite | MIT | @Animatica/platform, @Animatica/editor, @Animatica/engine |
| vitest | MIT | @Animatica/web, @Animatica/platform, @Animatica/editor, @Animatica/engine |
