...
- [DONE] [editor-modal-dev] [2026-02-24] Enhanced ScriptConsole/ExportModal with validation/UX improvements, implemented keyboard shortcuts (Undo/Redo), and added unit tests
