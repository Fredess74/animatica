...
- **2D Storyboard Mode**: Introduced a new mode for pre-visualization.
- **Improved Character Animation**: Enhanced coverage and stability for character rigs.
- **Humanoid Character Support**: Added `Humanoid` component for loading and rendering GLB models.
- **Bone Controller**: Implemented bone-level manipulation for character skeletons.
- **Release Preparation**: Established release checklist and pre-release verification steps.

### Fixed

- **CharacterRenderer Regressions**: Fixed unit tests and optimized animator updates using React.memo and forwardRef.
- **Version Synchronization**: Aligned versions across the monorepo.
